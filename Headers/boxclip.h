...
#define BoxC_Tr_Generic_(type,suffix,SUFFIX) MemC_Okay_Size_(type);union _boxc_tr_##suffix{boxc_tr*Core;struct{boxc_tr _PL_ Root,_PL_ Leaf,_PL_ Prev,_PL_ Next;ADDRESS Count,Total,Hidden;type Object;}_PL_ Wrap;};MemC_Type_Declare_(union,boxc_tr_##suffix,BOXC_TR_##SUFFIX)
	}
	Tr;
