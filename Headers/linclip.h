...
struct _lincase
{
	...
	const struct
	{
		...
		const struct
		{
			...
			//﹛and required (Buffer) size is (Length)▼(sizeof(address)ㄚ1) bytes,
			...
			//﹛If (IndexLine) is not NULL,
			//﹛then required (IndexLine) size is (Length)▼sizeof(address) bytes,
			//﹛and required (Buffer) size is (Length)▼(sizeof(address)ㄚ2) bytes,
			...
			//﹛If (IndexLine) is not NULL,
			//﹛then required (IndexLine) size is (Length)▼sizeof(address) bytes,
			//﹛and required (Buffer) size is (Length)▼(sizeof(address)ㄚ4) bytes,
			...
			//﹛If (IndexLine) is not NULL,
			//﹛then required (IndexLine) size is (Length)▼sizeof(address) bytes,
			//﹛and required (Buffer) size is (Length)▼(sizeof(address)ㄚ8) bytes,
